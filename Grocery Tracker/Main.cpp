 ...
 *	Ken Rodriguez
 *	April 17, 2021
 *	Grocery Tracker: An application that counts the number of occurrences of a single word
 *  in a document, then outputs the number of times each unique word appears. This
 *  application can also count the number of times a user-specified word is said
 *  and can produce a histogram based on the collected results. 
 */
...
/*
Description:
	Print a menu to the console to collect user input while checking for errors.
*/
void DrawMenu() {
